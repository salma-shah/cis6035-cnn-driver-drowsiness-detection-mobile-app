...
The Unified Process was followed to build this project; it saves cost, time, and prioritizes a flexible, incremental, and iterative approach.
...
* **Technology**: Flutter, Firebase & Firestore, BLOC state management, GitHub, MVMM architecture (Model-ViewModel-Model)
