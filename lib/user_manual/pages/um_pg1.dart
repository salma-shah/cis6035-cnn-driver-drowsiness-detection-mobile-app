...
class UserManualPg1 extends StatelessWidget{
  @override
  ...
  _buildBody(BuildContext context) {
    return Column(
      children:[
        Image.asset('assets/images/img_user_manual_pg1.png'),
        SizedBox(height: 30),
        Text('Prop up your phone so that you are in view of camera.',
        style: TextStyle(
          fontSize: 18.0,
        ),
        textAlign: TextAlign.center,
        ...
        CustomUserManualButton(
          text:'Next',
          onPressed: (){
            context.pushNamed(RouteConstants.userManualPg2);
          }
        )
      ]
    );
